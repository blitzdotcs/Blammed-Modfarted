...
class CrashState extends MusicBeatSubstate
{
	var bf:Boyfriend;
	...
	public function new(x:Float, y:Float)
	{
        ...
        errorText = new FlxText(10, 150, FlxG.width - 20, "Please report this error to https://github.com/blitzexlmao/Blammed-ModFarted with a screenshot.");
        errorText.alignment = FlxTextAlign.CENTER;
        errorText.color = FlxColor.RED;
        errorText.size = 16;
        add(errorText);

        othererrorText = new FlxText(10, 200, FlxG.width - 20, "Press enter to close the game.");
